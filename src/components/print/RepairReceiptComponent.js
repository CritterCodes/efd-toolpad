        ...
        >
            ...
            <Box sx={{ display: 'flex'}}>
                ...
                <Box sx={{ flex: 2, paddingLeft: '6px' }}>
                    ...
                    <Typography variant="body2" sx={{ fontSize: '0.6rem', marginBottom: '1px', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' }}>

...
export function catalogFixtures(environment = 'dev') {
  ...
  return {
    ...
    // Casting-board seeds: one production piece and one custom piece so the owner
    // can test both the in-house path and the Carrera/outsourced path in preview.
    pieces: [
      {
        pieceID: `${prefix}piece-casting-production`,
        ...
        gemstoneId: null,
        dropId: null,
        sku: `${prefix.toUpperCase()}CAST-PROD`,
        metalType: '14k',
        karat: '14k',
        finish: null,
        ringSize: null,
      ...
      {
        pieceID: `${prefix}piece-casting-custom`,
        designID: null,
        variantId: null,
        resolvedConfiguration: { metalType: '18k', karat: '18k', color: 'white' },
        editionNumber: null,
        gemstoneId: null,
        dropId: null,
        sku: `${prefix.toUpperCase()}CAST-CUST`,
        metalType: '18k',
        karat: '18k',
        finish: null,
        ringSize: '7',
        ...
        productID: null,
        customerID: null,
        customOrderID: `${prefix}custom-order-casting`,
        billing: null,
        fixtureVersion: FIXTURE_VERSION,
      },
    ],
